...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        ?>
            ...
            $insertquery = "insert into register (name,email,pass)values('$name','$email','$pass')";
    ...
    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>
        ...
        <section class="text-gray-600 body-font">
            <div class="container px-5 py-24 mx-auto flex  items-center">
                ...
                <div class="lg:w-2/6 md:w-1/2 backdrop-blur-xl bg-white/30  shadow-purple-400 border-2 hover:border-purple-400 rounded-3xl p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 shadow-xl">
                    <h2 class="text-gray-900 text-lg font-medium title-font mb-5">SIGN UP</h2>
                    <div class="relative mb-4">
                        <label for="full-name" class="leading-7 text-sm text-gray-600">Full Name</label>
                        <input type="text" id="full-name" name="name" class="w-full bg-white rounded border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                    <div class="relative mb-4">
                    ...
                    <div class="relative mb-4">
                        ...
                        <input type="password" id="pass" name="password" class="w-full bg-white rounded border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                    ...
                    <p class="text-xs text-gray-500 mt-3">Forget the password ?<a href=""> click here .....</a> </p>
                </div>
            </div>
        </section>
    </form>
    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-2/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto">
                <h1 class="flex-grow sm:pr-16 text-2xl font-medium title-font text-gray-900">Click Here to Register As Vendor...</h1>
                <a href="vsignup.php">
                    <button class="flex-shrink-0 text-white bg-purple-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded-2xl text-lg mt-10 sm:mt-0">Sign UP As Vendor</button></a>
            </div>
        </div>
    </section>
