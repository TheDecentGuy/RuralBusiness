...
<body>
  <header class="sticky top-0  text-gray-600 body-font bg-gradient-to-r from-violet-500 to-fuchsia-500 shadow-2xl rounded-2xl m-3">
  ...
  if (isset($_POST['submit'])) {
    ...
    $email_search = "select * from vendors where email='$email'";
    ...
    if ($email_count) {
      ...
      $_SESSION['country'] = $email_pass['country'];
      $_SESSION['city'] = $email_pass['city'];
      $_SESSION['zipcode'] = $email_pass['zipcode'];
      $_SESSION['vendor_id'] = $email_pass['id'];
  ...
  ?>
        <script>
          ...
          location.replace("vendor/vindex.php");
        </script>
      <?php
  ...
  <script>
    var typed = new Typed("#typingtxt", {
      strings: ["Enter your Credintial for the Vendor Login...."],
