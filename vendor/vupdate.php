    ...
    <div class="flex">
        <aside class="w-1/5 h-screen sticky top-0">
            <div class="h-[43rem] py-4 px-3 bg-cyan-400  rounded-xl shadow-2xl shadow-purple-400 m-3">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="vaddProduct.php" class="flex items-center p-2 text-base font-normal text-black rounded-lg hover:bg-gray-100 hover:text-black ">
        ...
        <main class="w-4/5 mr-3 ">
            ...
            ?>
                ...
                $cat = mysqli_real_escape_string($con, $_POST['pcatagory']);
                $quantity = mysqli_real_escape_string($con, $_POST['pquantity']);
                $price = mysqli_real_escape_string($con, $_POST['pprice']);
                $desc = mysqli_real_escape_string($con, $_POST['pdesc']);


                $updatequery = "UPDATE PRODUCTS SET prod_name='$name',prod_catagory='$cat',prod_price='$price',prod_desc='$desc',prod_qaut='$quantity',prod_img='$fileDestination' where prod_id='$id'";
                ...
                <div class=" m-3">
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full max-w-full px-3">
                            <div class="relative flex flex-col min-w-0 break-words bg-white border-0 shadow-2xl shadow-indigo-400 rounded-2xl bg-clip-border">
                                <div class="border-black/12.5 rounded-t-2xl border-b-0 border-solid p-6 pb-0">
                                    <div class="flex items-center">
                                        <p class="mb-0 text-indigo-500">Update Your Information </p>
                                    </div>
                                </div>
                                <div class="flex-auto p-6">
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                <label for="username" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Product
                                                    Name :</label>
                                                <input type="text" name="pname" value="<?php echo $_GET['pname']; ?>" class="text-sm leading-5.6 ease block w-64 appearance-none bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all placeholder:text-gray-500 ring-2 focus:ring-purple-500 focus:outline-none border-2 border-purple-400 rounded-2xl h-12 bg-slate-50">
                                            </div>
                                        </div>
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                ...
                                                <select class="text-sm leading-5.6 ease block w-64 appearance-none bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all placeholder:text-gray-500 ring-2 focus:ring-purple-500 focus:outline-none border-2 border-purple-400 rounded-2xl h-12 bg-slate-50" name="pcatagory" id="">
                                        ...
                                        <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                            <div class="mb-4">
                                                ...
                                                <input type="textarea" class="ring-2 focus:ring-purple-500 focus:outline-none border-2 border-purple-400 rounded-2xl p-2 bg-slate-50 h-32 w-64" name="pdesc" id="" cols="27" rows="6" value="<?php echo  $_GET['pdesc']; ?>" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex flex-wrap -mx-3">
                                            ...
                                            <div class="w-full flex">
                                                <div class="mb-4">
                                                    <label for="city" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Quanitity
                                                        :</label>
                                                    <input type="number" name="pquantity" value="<?php echo  $_GET['pqaut']; ?>" class="text-sm leading-5.6 ease block w-64 appearance-none bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all placeholder:text-gray-500 ring-2 focus:ring-purple-500 focus:outline-none border-2 border-purple-400 rounded-2xl h-12 bg-slate-50">
                                                </div>
                                                <div class="mx-4">
                                                    <label for="country" class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 dark:text-white/80">Price
                                                        :</label>
                                                    <input type="number" name="pprice" value="<?php echo $_GET['pprice']; ?>" class="text-sm leading-5.6 ease block w-64 appearance-none bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all placeholder:text-gray-500 ring-2 focus:ring-purple-500 focus:outline-none border-2 border-purple-400 rounded-2xl h-12 bg-slate-50">
                                                </div>
                                            </div>
                                        ...
                                        <div class="w-full flex justify-end">
                                            <a class="text-white bg-slate-400 border-0 py-2 px-8 focus:outline-none hover:bg-slate-300 hover:text-black rounded-2xl text-lg mr-2" href="vindex.php">cancel
                                            </a>
                                            <button name="delete" class="text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-400 rounded-2xl text-lg mr-2">Delete
                                            </button>
                                            <button name="update" type="submit" class="text-white bg-purple-500 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded-2xl text-lg">Update</button>
                                        </div>
