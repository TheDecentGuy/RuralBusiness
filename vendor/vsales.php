...
<body class="bg-slate-100">
    ...
    <div class="flex">
        <aside class="w-1/5 h-screen stikcy  top-0">
            <div class="h-[43rem] py-4 px-3  bg-cyan-400  rounded-xl shadow-2xl shadow-purple-400 m-3">
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="vsales.php" class="flex items-center p-2 text-base font-normal text-black rounded-lg bg-gray-100">
        ...
        <main class="w-4/5 mr-3">
            ...
            <div class="mt-4 ">
                <div class="backdrop-blur-lg bg-white/30 p-6 rounded-xl w-[41rem] ">
                    <h1 class="text-xl">Your Product Sales.....</h1>
                    <h1 class="">Following charts shows you that the Profit Gain & and the Losses of your Products..</h1>
                </div>
            </div>
            <div class="w-auto  h-auto border-2 border-purple-400 mt-4 p-6 shadow-2xl rounded-2xl shadow-purple-500 backdrop-blur-lg bg-white/30 ">
            ...
            <div class="mt-4 ">
                <div class="backdrop-blur-lg bg-white/30 p-6 rounded-xl w-[41rem] ">
                    <h1 class="text-xl">Annual Gains.....</h1>
                    <h1 class="">Following charts shows you that the Profit Gain & and the Losses of your Products..</h1>
                </div>
            </div>
            <div class="w-auto  h-auto border-2 border-purple-400 mt-4 p-6 shadow-2xl rounded-2xl shadow-purple-500 backdrop-blur-lg bg-white/30 ">
    ...
    <script>
        ...
        const data = {
            ...
            datasets: [{
                ...
                backgroundColor: 'rgb(178,75,243)',
                borderColor: 'rgb(230,230,250)',
                data: [1.5, 10, 5, 2, 20, 30, 45],
            }]
        };
